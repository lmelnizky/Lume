...
import org.lume.entity.scene.IOnAreaTouchListener;
import org.lume.entity.scene.IOnSceneTouchListener;
...
import org.lume.entity.util.FPSLogger;
import org.lume.examples.adt.messages.client.ClientMessageFlags;
import org.lume.examples.adt.messages.server.ConnectionCloseServerMessage;
import org.lume.examples.adt.messages.server.ServerMessageFlags;
import org.lume.extension.multiplayer.protocol.adt.message.IMessage;
import org.lume.extension.multiplayer.protocol.adt.message.server.IServerMessage;
import org.lume.extension.multiplayer.protocol.adt.message.server.ServerMessage;
import org.lume.extension.multiplayer.protocol.client.IServerMessageHandler;
import org.lume.extension.multiplayer.protocol.client.connector.ServerConnector;
import org.lume.extension.multiplayer.protocol.client.connector.SocketConnectionServerConnector;
import org.lume.extension.multiplayer.protocol.client.connector.SocketConnectionServerConnector.ISocketConnectionServerConnectorListener;
import org.lume.extension.multiplayer.protocol.server.SocketServer;
import org.lume.extension.multiplayer.protocol.server.SocketServer.ISocketServerListener;
import org.lume.extension.multiplayer.protocol.server.connector.ClientConnector;
import org.lume.extension.multiplayer.protocol.server.connector.SocketConnectionClientConnector;
import org.lume.extension.multiplayer.protocol.server.connector.SocketConnectionClientConnector.ISocketConnectionClientConnectorListener;
import org.lume.extension.multiplayer.protocol.shared.SocketConnection;
import org.lume.extension.multiplayer.protocol.util.MessagePool;
import org.lume.extension.multiplayer.protocol.util.WifiUtils;
...
import org.lume.ui.activity.SimpleBaseGameActivity;
                ...
                return new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("Connect", new OnClickListener() {
                            ...
                            public void onClick(final DialogInterface pDialog, final int pWhich) {
                                ...
                                initClient.execute(); //TODO tested AsyncTask here
//                                MultiplayerExample.this.initClient();
    ...
    private void initServerAndClient() {
        ...
        initClient.execute(); //TODO AsyncTask tested here
//        this.initClient();
    }
    ...
    public class InitClient extends AsyncTask<String, Void, String> {

        @Override
        protected String doInBackground(String[] params) {
            try {
                mServerConnector = new SocketConnectionServerConnector(new SocketConnection(new Socket(mServerIP, SERVER_PORT)), new ExampleServerConnectorListener());
