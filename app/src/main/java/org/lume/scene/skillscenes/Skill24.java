...
//                crackyStonesToRemove.clear();
    ...
    private void showStonesToScreen(int directionVariant, final boolean thornyFirst) {
        ...
        boolean shortBall = randomGenerator.nextBoolean();
        float speedFactor = (shortBall) ? 1.2f*factor : 1.5f*factor;
        addBall(false, directionVariant, gravityDirection, randomRow, speedFactor);
    }
