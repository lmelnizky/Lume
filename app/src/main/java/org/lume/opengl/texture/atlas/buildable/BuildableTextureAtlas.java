package org.lume.opengl.texture.atlas.buildable;
...
import org.lume.opengl.texture.atlas.ITextureAtlas;
...
import org.lume.opengl.texture.atlas.buildable.builder.ITextureAtlasBuilder.TextureAtlasBuilderException;
import org.lume.opengl.texture.atlas.source.ITextureAtlasSource;
import org.lume.opengl.util.GLState;
import org.lume.util.call.Callback;
...
public class BuildableTextureAtlas<S extends ITextureAtlasSource, T extends ITextureAtlas<S>> implements IBuildableTextureAtlas<S, T> {
	...
	public final ArrayList<TextureAtlasSourceWithWithLocationCallback<S>> mTextureAtlasSourcesToPlace = new ArrayList<TextureAtlasSourceWithWithLocationCallback<S>>();
