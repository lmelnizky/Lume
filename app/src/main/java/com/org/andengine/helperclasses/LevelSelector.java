...
public class LevelSelector extends Entity implements IScrollDetectorListener {
	...
	@Override
	public void onScrollStarted(ScrollDetector pScrollDetector, TouchEvent pSceneTouchEvent, int pPointerID, float pDistanceX, float pDistanceY) {

	}

	@Override
	public void onScroll(ScrollDetector pScrollDetector, TouchEvent pSceneTouchEvent, int pPointerID, float pDistanceX, float pDistanceY) {
		if(mIsVertical) {
	...
	@Override
	public void onScrollFinished(ScrollDetector pScrollDetector, TouchEvent pSceneTouchEvent, int pPointerID, float pDistanceX, float pDistanceY) {
